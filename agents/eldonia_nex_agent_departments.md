...
**正本（Source of Truth）** — 本書 > 個別 `agents/<category>/*.agent.md` > `docs/` レガシー記述。

**リポジトリ配置**: `agents/director/` · `development/` · `design/` · `product/` · `business/` · `strategy/`（各フォルダに README あり）
...
**リポジトリ Sub Agent**: `Request_Intake`, `Project_Producer`, `Explore`（`agents/director/*.agent.md`）
...
**Agent 定義**: `agents/strategy/Product_Strategy.agent.md`
...
| — | `Explore` | 読み取り専用探索（`agents/director/Explore.agent.md`） |
| — | `Django_Manager` | `backend/`（`agents/development/Django_Manager.agent.md`） |

**Agent 定義（Development）**: `agents/development/` — `Frontend_Manager`, `Backend_Manager`, `Database_Agent`, `Auth_Agent`, `DevOps_Agent`, `QA_Test_Agent`, `Accounting`
...
**Agent 定義**: `agents/design/UI_UX_Designer.agent.md`（Dark Fantasy / 黒×金。LP は紫アクセント可）
...
**Agent 定義**: `agents/product/Gallery_Manager.agent.md` — `src/app/gallery/`
...
**Agent 定義**: `agents/product/Community_Manager.agent.md` — `src/app/community/`
...
**Agent 定義**: `agents/product/Shop_Manager.agent.md` — `src/app/shop/`
...
**Agent 定義**: `agents/product/Events_Manager.agent.md` — `src/app/events/`
...
**Agent 定義**: `agents/product/Works_Manager.agent.md` — `src/app/works/`（Quest とは独立）
...
**Agent 定義**: `agents/product/Lab_Manager.agent.md` — `src/app/lab/`, `src/app/gallery/[id]/lab/`
...
**Agent 定義**: `agents/product/Quest_Manager.agent.md` — `src/app/api/quests/`, `/works/manage`
...
**Agent 定義**: `agents/product/Fan_Notification_Manager.agent.md`
...
**Agent 定義**: `agents/product/Portfolio_Passport_Manager.agent.md` — `src/app/works/portfolio/`
...
**Agent 定義**: `agents/business/Revenue_Payment_Manager.agent.md` — Sub: `agents/development/Accounting.agent.md`, `agents/development/Django_Manager.agent.md`, `agents/development/Backend_Manager.agent.md`
...
**Agent 定義**: `agents/business/Moderation_Safety_Manager.agent.md`
...
**Agent 定義**: `agents/business/Support_Desk_Manager.agent.md` — `src/app/help/`, `src/app/admin/support/`
...
**Agent 定義**: `agents/business/Marketing_Manager.agent.md` — LP: `src/app/page.tsx`, `src/lib/lp/`
...
**Agent 定義**: `agents/business/Admin_Audit_Manager.agent.md` — `src/app/admin/`（Next）、`backend/` Django `/admin/`（移行中）
